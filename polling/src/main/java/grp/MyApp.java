...
public class MyApp extends Application<Configuration> {
    ...
    public static class RestResource {
        ...
        public Response getAll() {
            return Optional.ofNullable(request.evaluatePreconditions(lastMofified))
                    .orElse(Response.ok(myDAO.getAll(50)).lastModified(lastMofified))
                    .cacheControl(CacheControl.valueOf("max-age=10")).build();
